...
readsDir <- "/home/ubuntu/data/5TB/BS-seq"
metaDB <- "../../extraSpace/SRAmetadb.sqlite"
mySamplesFile <- "/home/ubuntu/data/5TB/BS-seq/BS-seq.txt"
autoAnnotation <- "/home/ubuntu/data/5TB/BS-seq/annotation/automaticallyGeneratedAnnotation.csv"
