...
### Load input files 
counts = read.delim("~/Desktop/BreastCan_Input_ForDeSeq_uniq", header=F, row.names=1)
...
pdf("BC_WT_Canc_DESeq-dispersion_estimates.pdf")
...
write.csv(result, "DESeq-WT-vs-Canc.csv")

# Plotting Results to a pdf file
pdf("WT_Canc_DESeq-MA-plot.pdf")
plot(
  result$baseMean,
